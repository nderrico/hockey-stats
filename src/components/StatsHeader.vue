<template>
  <div class="stats-header flex items-center bg-gray-300 p-4 relative">
    ...
    <button 
      ...
      class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 absolute right-4"
    >
...
export default {
  ...
  emits: ['update:homeTeam', 'update:awayTeam', 'update:shootingDirection']
};
</script>
